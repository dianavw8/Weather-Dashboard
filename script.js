...
function renderSearchHistory() {
    ...
    for (var i = searchHistory.length - 1; i >= 0; i--) {
        ...
        btn.classList.add('recent-search-btn', 'btn', 'btn-outline-secondary');
...
function renderCurrentWeather(city, weather) {
    ...
    cardBody.setAttribute('class', 'card-body text-white bg-success');
    ...
    weatherIcon.setAttribute('class', 'main-weather-icon');
